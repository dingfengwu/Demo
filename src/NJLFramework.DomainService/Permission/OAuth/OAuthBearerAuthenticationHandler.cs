        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(requestTokenContext.Token))
                {
                    ...
                    return AuthenticateResult.Fail(new Exception("access token is empty"));
                }
                ...
                if (ticket == null)
                {
                    ...
                    return AuthenticateResult.Fail(new Exception("invalid bearer token received"));
                }
                    ...
                    ticket.Properties.ExpiresUtc.Value < currentUtc)
                {
                    ...
                    return AuthenticateResult.Fail(new Exception("expired bearer token received"));
                }
                ...
                {
                    return AuthenticateResult.Fail(context.Error);
                }
