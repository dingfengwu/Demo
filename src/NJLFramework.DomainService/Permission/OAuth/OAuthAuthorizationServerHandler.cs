...
namespace NJLFramework.DomainService.Permission
{
    public class OAuthAuthorizationServerHandler : AuthenticationHandler<OAuthAuthorizationServerOptions>
    {
        ...
        private async Task InvokeTokenEndpointAsync()
        {
            ...
            var tokenEndpointRequest = new TokenEndpointRequest(form.AsQueryCollection());
        ...
        private async Task<bool> InvokeAuthorizeEndpointAsync()
        {
            ...
            {
                Logger.LogDebug("Authorize endpoint request missing required response_type parameter");
            ...
            {
                Logger.LogDebug("Authorize endpoint request contains unsupported response_type parameter");
